...
"""
Ta klasa jest iterable i jednocześnie jest swoim własnym iteratorem. Podziel ją na 2 klasy:

CombinationsIterator, która nie jest iterowalna ale posiada metodę __next__

Combinations, która nie posiada funkcji __next__ i dla której iteratorem jest klasa CombinationsIterator

Definiując klasy usuń z nich niewykorzystywane metody, atrybuty i zmienne
"""